...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <!-- content body -->
  <div class="w3-container">
   <a href="../system/admin_account.jsp">    
	...
	<br>
  <div class="container">
  <form action="../system/UpdateAdminAccount.jsp" method="post">
    <%
    ...
    <div class="row">
      <div class="col-25">
        <label for="adminName">Fullname</label>
      </div>
      <div class="col-75">
        <input type="text" id="adminName" name="adminName" value="<%=rs1.getString("adminName")%>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="adminPhoneNo" name="adminPhoneNo" value="<%=rs1.getString("adminPhoneNo")%>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="adminEmail" name="adminEmail" value="<%=rs1.getString("adminEmail")%>">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <div class="password-container">
			<input type="password" value="<%=rs1.getString("adminPassword")%>" id="password" name="adminPassword">
			<i class="pwdicon fa-solid fa-eye" id="eye"></i>
		</div>
      </div>
    </div>
  
       <input type="hidden" name="adminId" value="<%=rs1.getInt("adminId")%>"/><br>
