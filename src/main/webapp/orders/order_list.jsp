      ...
      <tr>
        ...
        <button style="background-color: #A189A9; border:1px black solid; cursor:pointer;">Print</button>
           ...
           <button class="tableButton ButtonView">
              <a href="../orders/view_order.jsp?orderNo=<%= orderNo %>"><i class="fa fa-eye"></i></a>
             
			</button>
			          
           
           <button class="tableButton ButtonDelete">
           		<a href="../orders/DeleteOrderController.jsp?orderNo=<%= orderNo %>&deleteStatus=success" onclick="return confirm('Are you sure you want to delete this order?')"><i class="fa fa-trash"></i></a>
