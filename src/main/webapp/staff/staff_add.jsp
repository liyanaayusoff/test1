...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> New Staff </b></h5>
  </header>
  ...
  <form action="../AddStaffController" method="post">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="staffName" name="staffName" placeholder="">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="staffPhoneNo" name="staffPhoneNo" placeholder="">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="staffEmail" name="staffEmail" placeholder="">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <div class="password-container">
			<input type="password" placeholder="" id="password" name="staffPassword">
