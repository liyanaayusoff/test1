...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Update Staff </b></h5>
  </header>
  ...
  <form action="UpdateStaffController" method="post">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="staffName" name="staffName" value="<c:out value="${s.staffName}"/>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="staffPhoneNo" name="staffPhoneNo" value="<c:out value="${s.staffPhoneNo}"/>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="staffEmail" name="staffEmail" value="<c:out value="${s.staffEmail}"/>">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <div class="password-container">
			<input type="password" value="<c:out value="${s.staffPassword}"/>" id="password" name="staffPassword">
	...
	<div class="row">
      ...
      <div class="col-75">
        <select id="userType" name="userType">
		  <option value="<c:out value="${s.userType}"/>"><c:out value="${s.userType}"/></option>
