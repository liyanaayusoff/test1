...
try {
    ...
    PreparedStatement stmt = con.prepareStatement("UPDATE inventory SET invName=?, invBrand=?, invType=?, purchasePrice=?, sellingPrice=?, expDate=?, invQty=? WHERE invId=?");
    ...
    stmt.setInt(8, Integer.parseInt(invId));
    ...
    response.sendRedirect("../staff-file/s-inventory_list.jsp?message=Inventory item updated successfully.");
