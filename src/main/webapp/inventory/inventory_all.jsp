...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <!-- content body -->
  <div class="w3-container">
	 <a href="../inventory/inventory_add.jsp">    
        ...
        <td><%= minInvLevel %></td>
         <td><%= totalSoldQty %></td>
           ...
           <button class="tableButton ButtonView">
              <a href="../inventory/inventory_view.jsp?invId=<%= invId %>"><i class="fa fa-eye"></i></a>
			</button>
			           
           <button class="tableButton ButtonUpdate">
              <a href="../inventory/inventory_update.jsp?invId=<%= invId %>"><i class="fa fa-pencil"></i></a>
			</button>
           
           <button class="tableButton ButtonDelete">
                <a href="../inventory/DeleteInventoryController.jsp?invId=<%= invId %>"&deleteStatus=success"  onclick="return confirm('Are you sure you want to delete this inventory?')" id="myFunction()"><i class="fa fa-trash"></i></a>
		   </button>
